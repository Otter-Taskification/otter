 ...
 */
void otter_trace_initialise(const char* file, const char* func, int line);
 ...
 */
void otter_trace_finalise(void);
 ...
 * @param line The line in @param file at which this call appears.
 */
void otter_threads_begin(const char* file, const char* func, int line);
 ...
 */
void otter_task_begin(const char* file, const char* func, int line);
 ...
 * 
 */
void otter_loop_iteration_begin(void);
 ...
 * 
 */
void otter_loop_iteration_end(void);
 ...
 * 
 */
void otter_synchronise(otter_sync_t mode);
 ...
 * 
 */
void otter_phase_begin( const char* name );
 ...
 * 
 */
void otter_phase_switch( const char* name );
