 ...
 * @brief Defines pre-processor tokens which stand in for the actual otter-task-graph API.
 * @version 0.2.0
 * @date 2022-03-13
 * 
 * This file defines pre-processor tokens which stand in for the actual
 * otter-task-graph API, for use by users of sofware which includes Otter but does
