...
void trace_task_manager_add_task(trace_task_manager_t *, const char *,
                                 otter_task_context *);
otter_task_context *trace_task_manager_get_task(trace_task_manager_t *,
                                                const char *);
otter_task_context *trace_task_manager_pop_task(trace_task_manager_t *,
                                                const char *);
otter_task_context *trace_task_manager_borrow_task(trace_task_manager_t *,
                                                   const char *);
