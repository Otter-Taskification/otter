...
static void on_ompt_callback_target(ompt_target_t kind,
                                    ...
                                    int device_num, ompt_data_t *task,
                                    ompt_id_t target_id,
                                    const void *codeptr_ra);
#endif
...
static void on_ompt_callback_dependences(ompt_data_t *task,
                                         const ompt_dependence_t *deps,
                                         int ndeps);
#endif

#if defined(implements_callback_task_dependence)
static void on_ompt_callback_task_dependence(ompt_data_t *src_task,
...
static void on_ompt_callback_flush(ompt_data_t *thread, const void *codeptr_ra);
#endif

#if defined(implements_callback_cancel)
static void on_ompt_callback_cancel(ompt_data_t *task, int flags,
                                    const void *codeptr_ra);
#endif
